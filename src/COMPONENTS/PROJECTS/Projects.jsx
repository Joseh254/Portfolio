...
function Projects() {
  const projects = [
...

    {
      ...
      description:
        "A full stack system that intergrates Machine learning to detect if a patient has VSD.It intergrates external api to work efficiently",
      techStack: " Postgress, Express, Nodejs, React, CSS, JavaScript",
      image: vsd,
...

    {
      title: "Lipa Na Mpesa",
      description:
        "A full stack project that intergrates Daraja api to send stk push to customers,.it allows customers to pay online.",
      techStack: " Postgress, Express, Nodejs, React, CSS, JavaScript",
      image: mpesa,
      link: "https://joseph-mbugua-portfolio.vercel.app/",
    },
    ...
    },
    {
      ...
      description: "Mut website that shows details about the tech club.",
      techStack: "React, Css & Javascript",
      image: project3,
    ...
    },
    {
      ...
      description: "A travel tour website that shows various places to visit.",
      techStack: "React, Css & Javascript",
      image: project5,
